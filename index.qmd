...
Note that the web version of this thesis differs slightly from [the PDF version](https://github.com/damian-oswald/master-thesis/docs/damian-oswald-master-thesis.pdf) that I submitted at April 28, 2023 -- mainly because the web version uses colored graphics, and because some minor content was rearranged for a better legibility and user experience.
